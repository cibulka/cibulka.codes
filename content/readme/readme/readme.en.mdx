...
<details>
  ...
  My portfolio also contains my short at [Tetris game](https://www.cibulka.codes/tetris). Give it a try, eveng if it's a bit addictive! 🍭 Or check [the repo of the project](https://www.github.com/cibulka/react-tetris-ts).
</details>
